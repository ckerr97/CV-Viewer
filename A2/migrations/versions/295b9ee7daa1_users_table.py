...
Revision ID: 295b9ee7daa1
Revises: 
Create Date: 2020-11-20 19:55:52.977780
...
def upgrade():
    ...
    op.create_index(op.f('ix_user_contact_no'), 'user', ['contact_no'], unique=False)
...
def downgrade():
    ...
    op.drop_index(op.f('ix_user_contact_no'), table_name='user')
